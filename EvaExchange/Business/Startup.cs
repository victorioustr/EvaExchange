...
namespace Business
{
    public partial class BusinessStartup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services)
        {
            ...
            ValidatorOptions.Global.DisplayNameResolver = (type, memberInfo, expression) => memberInfo.GetCustomAttribute<DisplayAttribute>()
                    ?.GetName();
        }
        ...
        public void ConfigureDevelopmentServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IUserPortfolioEventRepository, UserPortfolioEventRepository>();
            services.AddTransient<IUserPortfolioRepository, UserPortfolioRepository>();
            services.AddTransient<IShareRateHistoryRepository, ShareRateHistoryRepository>();
            ...
            services.AddDbContext<ProjectDbContext, QTInMemory>(ServiceLifetime.Transient);
