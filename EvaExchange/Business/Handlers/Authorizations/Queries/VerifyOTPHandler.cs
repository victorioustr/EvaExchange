...
{
    public class VerifyOtpHandler : IRequestHandler<VerifyOtpCommand, IDataResult<QTToken>>
    {
        readonly IAuthenticationCoordinator _coordinator;
        ...
        public async Task<IDataResult<QTToken>> Handle(VerifyOtpCommand request, CancellationToken cancellationToken)
        {
