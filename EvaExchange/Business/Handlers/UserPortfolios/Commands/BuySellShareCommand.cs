...
namespace Business.Handlers.UserPortfolios.Commands
{
    ...
    public class BuySellShareCommand : IRequest<IResult>
    {
        ...
        public class BuySellShareCommandHandler : IRequestHandler<BuySellShareCommand, IResult>
        {
            readonly IMediator _mediator;
            readonly IHttpContextAccessor _contextAccessor;
            readonly ICacheManager _cacheManager;

            public BuySellShareCommandHandler(IMediator mediator, IHttpContextAccessor contextAccessor, ICacheManager cacheManager)
            {
            ...
            public async Task<IResult> Handle(BuySellShareCommand request, CancellationToken cancellationToken)
            {
                ...
                var portfolio = await _mediator.Send(new GetUserPortfolioByUserIdShareIdQuery { UserId = request.UserId, ShareId = share.Data.Id });
                ...
                var userPortfolioEvent = new CreateUserPortfolioEventCommand
                {
