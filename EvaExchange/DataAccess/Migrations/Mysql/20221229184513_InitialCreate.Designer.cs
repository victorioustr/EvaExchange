...
namespace DataAccess.Migrations.Mysql
{
    ...
    [Migration("20221229184513_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concrete.ShareRateHistory", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
                    ...
                    b.ToTable("ShareRateHistories");
                });

            modelBuilder.Entity("Entities.Concrete.UserPortfolio", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
            ...
            modelBuilder.Entity("Entities.Concrete.UserPortfolioEvent", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varbinary(16)");
                    ...
                    b.Property<int>("UserPortfolioEventType")
                        .HasColumnType("int");

                    b.Property<byte[]>("UserPortfolioId")
                        .IsRequired()
                        .HasColumnType("varbinary(16)");

                    b.HasKey("Id");

                    b.HasIndex("UserPortfolioEventType");

                    b.HasIndex("UserPortfolioId");

                    b.ToTable("UserPortfolioEvents");
                });

            modelBuilder.Entity("Entities.Concrete.ShareRateHistory", b =>
                {
                    b.HasOne("Entities.Concrete.Share", "Share")
                        .WithMany("ShareRateHistories")
            ...
            modelBuilder.Entity("Entities.Concrete.UserPortfolioEvent", b =>
                {
                    b.HasOne("Entities.Concrete.UserPortfolio", "UserPortfolio")
                        .WithMany("UserPortfolioEvents")
            ...
            modelBuilder.Entity("Entities.Concrete.Share", b =>
                {
                    b.Navigation("ShareRateHistories");
            ...
            modelBuilder.Entity("Entities.Concrete.UserPortfolio", b =>
                {
                    b.Navigation("UserPortfolioEvents");
                });
