        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalUserId = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobilePhones = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: true),
                    ...
                    UpdateContactDate = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    ShareId = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    Rate = table.Column<decimal>(type: "decimal(18, 2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    UserPortfolioId = table.Column<byte[]>(type: "varbinary(16)", nullable: false),
                    UserPortfolioEventType = table.Column<int>(type: "int", nullable: false),
                    Lot = table.Column<int>(type: "int", nullable: false),
                    Rate = table.Column<decimal>(type: "decimal(18, 2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime", nullable: true),
