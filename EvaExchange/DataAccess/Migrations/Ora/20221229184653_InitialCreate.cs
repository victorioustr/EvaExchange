...
namespace DataAccess.Migrations.Ora
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "1, 1"),
                    MessageTemplate = table.Column<string>(type: "NVARCHAR2(2000)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalUserId = table.Column<string>(type: "NVARCHAR2(20)", maxLength: 20, nullable: false),
                    Code = table.Column<int>(type: "NUMBER(10)", maxLength: 50, nullable: false),
                    SendDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    IsSend = table.Column<bool>(type: "NUMBER(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedUser = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    UpdatedUser = table.Column<int>(type: "NUMBER(10)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "1, 1"),
                    LangId = table.Column<int>(type: "NUMBER(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "1, 1"),
                    CitizenId = table.Column<long>(type: "NUMBER(19)", nullable: false),
                    ...
                    MobilePhones = table.Column<string>(type: "NVARCHAR2(30)", maxLength: 30, nullable: true),
                    ...
                    UpdateContactDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    PasswordSalt = table.Column<byte[]>(type: "RAW(2000)", nullable: true),
                    PasswordHash = table.Column<byte[]>(type: "RAW(2000)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "ShareRateHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    ShareId = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    Rate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShareRateHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShareRateHistories_Shares_ShareId",
                        column: x => x.ShareId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPortfolios_Shares_ShareId",
                        column: x => x.ShareId,
                        principalTable: "Shares",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "UserPortfolioEvents",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    UserPortfolioId = table.Column<Guid>(type: "RAW(16)", nullable: false),
                    UserPortfolioEventType = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Lot = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    Rate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPortfolioEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPortfolioEvents_UserPortfolios_UserPortfolioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShareRateHistories_ShareId",
                table: "ShareRateHistories",
                column: "ShareId");

            migrationBuilder.CreateIndex(
                name: "IX_ShareRateHistories_UpdatedDate",
                table: "ShareRateHistories",
                column: "UpdatedDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPortfolioEvents_UserPortfolioEventType",
                table: "UserPortfolioEvents",
                column: "UserPortfolioEventType");

            migrationBuilder.CreateIndex(
                name: "IX_UserPortfolioEvents_UserPortfolioId",
                table: "UserPortfolioEvents",
                column: "UserPortfolioId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPortfolios_ShareId",
