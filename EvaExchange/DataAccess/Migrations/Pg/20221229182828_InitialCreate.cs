    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => table.PrimaryKey("PK_MobileLogins", x => x.Id));
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedUser = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table => table.PrimaryKey("PK_Shares", x => x.Id));
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => table.PrimaryKey("PK_UserClaims", x => new { x.UserId, x.ClaimId }));
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserPortfolioId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserPortfolioEventType = table.Column<int>(type: "integer", nullable: false),
                    Lot = table.Column<int>(type: "integer", nullable: false),
                    Rate = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
